...
var getUserCards = function (args, pubsub, mongo) { return __awaiter(void 0, void 0, void 0, function () {
    var gameId, name, db, gameCollection, currentGame, blackCard, cardCollection, numberOfCardsets, randomInt, deck, cards;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                randomInt = Math.floor(Math.random() * numberOfCardsets);
                return [4 /*yield*/, cardCollection.find().limit(1).skip(randomInt).next()];
            case 4:
                deck = _a.sent();
