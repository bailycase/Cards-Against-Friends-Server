...
export declare class ModuleSessionInfo<Config = any, Session extends object = any, Context = any> {
    ...
    get module(): GraphQLModule<Config, Session, Context, Partial<{
        [key: string]: import("graphql").GraphQLScalarType | (() => any) | import("graphql-tools").IEnumResolver | Partial<import("graphql-tools").IResolverObject<any, ModuleContext<Context>, any>> | import("graphql-tools").IResolverOptions<any, ModuleContext<Context>, any>;
    }>>;
    get session(): Session;
